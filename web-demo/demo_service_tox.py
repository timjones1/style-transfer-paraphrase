...
with torch.cuda.device(0):
    ...
    toxic = GPT2Generator(OUTPUT_DIR + "/models/toxic")
    print("Loading Less insulting  model...")
    less_insult = GPT2Generator(OUTPUT_DIR + "/models/less_insult")
#     print("Loading Romantic Toxicity model...")
...
style_mapping = {
    ...
    "Toxic": {"model": toxic, "device": 0, "data_file": "shakespeare"},
    "Less Insulting": {"model": less_insult, "device": 0, "data_file": "less_insulting"},
}
...
data_style_mapping = {
    ...
    # "less_insulting": {"data_file": "less_insulting"},
}
...
if os.path.exists(OUTPUT_DIR + "/all_styles_clean.pkl"):
    ...
    for style, data in data_style_mapping.items():
        with open("../data_samples/{}.txt".format(data["data_file"]), "r", encoding='utf8') as f:
